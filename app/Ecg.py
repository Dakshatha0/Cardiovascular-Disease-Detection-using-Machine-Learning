...
class ECG:
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		loaded_model = joblib.load('predictmodel.pkl')
		result = loaded_model.predict(final_df)

		print(loaded_model)
		
		if result[0] == 1:
			return "The uploaded ECG image exhibits signs consistent with myocardial infarction. Please consult a medical professional for accurate diagnosis and treatment."
		elif result[0] == 0:
			return "The uploaded ECG image shows signs indicative of an abnormal heartbeat. Please seek advice from a medical professional for accurate assessment and appropriate management."
		elif result[0] == 2:
			return "The uploaded ECG image appears normal. For any concerns or further evaluation, please consult with a qualified healthcare provider."
		else:
			return "The ECG image indicates a history of myocardial infarction. Continual consultation with a medical professional is advised for appropriate care and management."
